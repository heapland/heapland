...
case class PgConnection(name: String, database: String, username: String, password: String, hostname: String, port: Int = 5432)
    extends ServiceConnection
case class MySQLConnection(name: String, database: String, username: String, password: String, hostname: String, port: Int = 3306)
    extends ServiceConnection
